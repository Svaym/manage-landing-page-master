    ...
    <section className='pt-28'>
      <div className="container">
        <div className='flex md:flex-col md:gap-y-7'>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className="absolute -z-10 -left-[42rem] top-64 md:-top-[43rem] md:left-[18.5rem] xxs:left-[13.5rem]" width="814" height="814"><rect width="436" height="970" x="774" y="-62" fill="#FFF0EC" fill-rule="evenodd" rx="218" transform="rotate(45 718.814 -291.157)"/></svg>
          ...
          <div className='ml-5 w-2/3 lg:w-full lg:ml-0 xs:px-2'>
            {data.map((item) => (
              <>
                <div className='flex items-center gap-x-3 lg:gap-x-1 md:justify-center md:gap-x-3'>
